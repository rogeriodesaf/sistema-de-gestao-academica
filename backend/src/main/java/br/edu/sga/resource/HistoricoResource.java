...
public class HistoricoResource {
    ...
    public List<HistoricoConsultaDTO> listar() {
        return entityManager.createQuery("""
                select h.id, a.nome, c.nome, d.nome, d.codigo, m.nome, h.periodoCursado,
                       h.cargaHoraria, d.creditos, h.notaFinal, h.frequenciaFinal,
                       h.situacao, p.nome
    ...
    private HistoricoConsultaDTO dto(Object[] item) {
        ...
        return new HistoricoConsultaDTO((Long) item[0], (String) item[1], (String) item[2],
                ...
                situacao == null ? null : situacao.name(), (String) item[12]);
    }
